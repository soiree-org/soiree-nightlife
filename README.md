...
Your device's location is periodically queried both in the foreground and in the background in order to find nearby establishments to check into and occasionally prompt the user to check in. This location data is never stored on our servers.
